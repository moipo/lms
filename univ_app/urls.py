...
urlpatterns = [
    ...
    #testser
    path('test/',General.homepage, name = "homepage"),
    ...
    # path('test/feedback/', General.feedback, name = "feedback"),
    path('test/access_denied/', General.access_denied, name = "access_denied"),
    path('test/show_my_profile/', General.show_my_profile, name = "show_my_profile"),
    path('test/change_user_credentials/', General.change_user_credentials, name = "change_user_credentials"),
    ...
    #general
    path('',Main.homepage, name = "main_homepage"),
